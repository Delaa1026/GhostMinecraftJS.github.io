...
class GlowCookies {
    constructor() {
        this.banner = void 0, this.config = void 0, this.tracking = void 0, this.PreBanner = void 0, this.Cookies = void 0
    }
    render() {
    ...
    openManageCookies() {
        this.config.hideAfterClick ? this.PreBanner.style.display = "none" : this.PreBanner.style.display = "block", this.Cookies.style.display = "none"
    }
    openSelector() {
        this.PreBanner.style.display = "none", this.Cookies.style.display = "block"
    }
    acceptCookies() {
    ...
    addCustomScript() {
        if (void 0 !== this.tracking.customScript) {
            let e;
            this.tracking.customScript.forEach((t => {
                "src" === t.type ? (e = document.createElement("script"), e.setAttribute("src", t.content)) : "custom" === t.type && (e = document.createElement("script"), e.text = t.content), "head" === t.position ? document.head.appendChild(e) : document.body.appendChild(e)
            }))
        }
    }
    start(e, t) {
        null == t && (t = {}), this.config = {
            border: t.border || "border",
            position: t.position || "left",
            hideAfterClick: t.hideAfterClick || !1
        }, this.tracking = {
            AnalyticsCode: t.analytics || void 0,
            FacebookPixelCode: t.facebookPixel || void 0,
            HotjarTrackingCode: t.hotjar || void 0,
            customScript: t.customScript || void 0
        }, "en" === e ? this.banner = {
            description: t.bannerDescription || "We use our own and third-party cookies to personalize content and to analyze web traffic.",
            linkText: t.bannerLinkText || "Read more about cookies",
            link: t.policyLink || "#link",
            background: t.bannerBackground || "#fff",
            color: t.bannerColor || "#505050",
            heading: t.bannerHeading || "",
            acceptBtn: {
                text: t.acceptBtnText || "Accept cookies",
                background: t.acceptBtnBackground || "#24273F",
                color: t.acceptBtnColor || "#fff"
            },
            rejectBtn: {
                text: t.rejectBtnText || "Reject",
                background: t.rejectBtnBackground || "#E8E8E8",
                color: t.rejectBtnColor || "#636363"
            },
            manageCookies: {
                color: t.manageColor || "#red",
                background: t.manageBackground || "#fff",
                text: t.manageText || "Manage cookies"
            }
        } : "es" === e && (this.banner = {
            description: t.bannerDescription || "Utilizamos cookies propias y de terceros para personalizar el contenido y para analizar el tráfico de la web.",
            linkText: t.bannerLinkText || "Ver más sobre las cookies",
            link: t.policyLink || "#link",
            background: t.bannerBackground || "#fff",
            color: t.bannerColor || "#505050",
            heading: t.bannerHeading || "",
            acceptBtn: {
                text: t.acceptBtnText || "Aceptar cookies",
                background: t.acceptBtnBackground || "#24273F",
                color: t.acceptBtnColor || "#fff"
            },
            rejectBtn: {
                text: t.rejectBtnText || "Rechazar",
                background: t.rejectBtnBackground || "#E8E8E8",
                color: t.rejectBtnColor || "#636363"
            },
            manageCookies: {
...
//# sourceMappingURL=/sm/9118117f84a10a8f6adb0321038d5ad9f6629ff73bec6df2b7972eb70b243ded.map